...
# Install Apicurio
oc process -f apicurio.yml --KC_USER="Keycloak Admin Username" --KC_PASS="Keycloak Admin Password" --KC_REALM="Keycloak Realm" --DB_USER="PostgreSQL Connection Username" --DB_PASS="PostgreSQL Connection Password" --AUTH_ROUTE="Authentication Route Name" --WS_ROUTE="Editing Route Name" --API_ROUTE="API Route Name" --UI_ROUTE="User Interface Route Name" create
